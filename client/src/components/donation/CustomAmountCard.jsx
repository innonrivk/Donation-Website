...
export default function CustomAmountCard({ onDonate }) {
  ...
  const handleSubmit = () => {
    ...
    if (value > 10000) {
      setError('Maximum donation is $10,000/mo');
      return;
    }
    setError('');
    onDonate(value);
  ...
  const presetAmounts = [5, 15, 35, 75];
  ...
  return (
    <div className="custom-card">
      ...
      <div className="custom-card__content">
        ...
        <h3 className="custom-card__title">Custom Amount</h3>
        <p className="custom-card__desc">Choose your own monthly donation amount</p>
